...
class BrayDataset(Dataset):
    def __init__(
        ...
        """
        Dataset for cell morphology features to predict Mechanism of Action (MoA).
        ...
        Args:
            ...
            split_column (str): Which column to use for train/test splitting
        ...
        self.moa_columns = [
            col
            for col in labels_df_raw.columns
        ...
        self.feature_columns = [
            col
            for col in data_df_raw.columns
        ...
        features_array = merged_df[self.feature_columns].values.astype(np.float32)
        targets_raw_array = merged_df[self.moa_columns].values.astype(np.float32)
